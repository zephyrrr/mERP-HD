...
//{
//    [Class(Table = "业务过程_出口票_海关查验", OptimisticLock = OptimisticLockMode.Version)]
//    public class 出口票过程海关查验 : LogEntity,
//        IOnetoOneChildEntity<出口票过程报关, 出口票过程海关查验>
//    {
//        #region "Interface"
//        出口票过程报关 IOnetoOneChildEntity<出口票过程报关, 出口票过程海关查验>.ParentEntity
//        {
//            get { return 报关过程; }
//            set { 报关过程 = value; }
//        }
...
//        /// 票信息
//        /// </summary>
//        [OneToOne(Cascade = "none", Fetch = NHibernate.Mapping.Attributes.FetchMode.Join, Constrained = true, ForeignKey = "FK_过程海关查验_出口票过程报关")]
...
//        [ManyToOne(Insert = false, Update = false, ForeignKey = "FK_出口票_海关查验场地")]
...
//        [ManyToOne(Insert = false, Update = false, ForeignKey = "FK_出口票_海关查验陪同人")]
...
//        [ManyToOne(Insert = false, Update = false, ForeignKey = "FK_出口票_移交处理部门")]
...
//        [ManyToOne(Insert = false, Update = false, ForeignKey = "FK_出口票_移交经手人")]
