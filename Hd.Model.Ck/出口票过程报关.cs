...
//{
//    [Class(Table = "业务过程_出口票_报关", OptimisticLock = OptimisticLockMode.Version)]
//    public class 出口票过程报关 : SubmittedEntity,
//        IOnetoOneChildEntity<出口票, 出口票过程报关>,
//        IOnetoOneParentGenerateChildEntity<出口票过程报关, 出口票过程海关查验>
//    {
//        #region "Interface"
//        出口票 IOnetoOneChildEntity<出口票, 出口票过程报关>.ParentEntity
//        {
//            get { return 票; }
//            set { 票 = value; }
//        }

//        出口票过程海关查验 IOnetoOneParentEntity<出口票过程报关, 出口票过程海关查验>.ChildEntity
//        {
//            get { return 海关查验过程; }
//            set { 海关查验过程 = value; }
//        }

//        Type IOnetoOneParentGenerateChildEntity<出口票过程报关, 出口票过程海关查验>.ChildType
//        {
//            get { return 海关查验 ? typeof(出口票过程海关查验) : null; }
//        }
//        #endregion
...
//        /// 票信息
//        /// </summary>
//        [OneToOne(Cascade = "none", Fetch = NHibernate.Mapping.Attributes.FetchMode.Join, Constrained = true, ForeignKey = "FK_出口票过程报关_出口票")]
...
//        public virtual 出口票过程海关查验 海关查验过程
//        {
//            get;
//            set;
//        }
...
//        ///报关员
//        ///</summary>
//        [ManyToOne(Insert = false, Update = false, ForeignKey = "FK_出口票_报关员")]
...
//        ///港区放行地
//        ///</summary>
//        [ManyToOne(Insert = false, Update = false, ForeignKey = "FK_出口票_港区放行地")]
